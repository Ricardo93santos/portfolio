  ...
  return (
    <section className="container about">
      ...
      <div className="about_text">
        ...
        <p>Se você procura alguém comprometido e entusiasmado para criar soluções incríveis, <Link className="WaLink" to="https://wa.me/+5577933016666?text=Olá%20Ricardo,%20gostaria%20de%20saber%20mais%20sobre%20seus%20serviços!%20Vamos%20conversar?" target="_blank" rel="noopener noreferrer">vamos conversar!</Link></p>        
      </div>
    </section>
  );
}
