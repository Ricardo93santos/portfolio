  ...
  return (
    <section className="container about">
      ...
      <div className="about_text">
        ...
        <p>Se você procura alguém comprometido e entusiasmado para criar soluções incríveis, <a className="WaLink" href="https://wa.me/+5577933016666?text=Olá%20Ricardo,%20gostaria%20de%20saber%20mais%20sobre%20seus%20serviços!%20Vamos%20criar%20um%20site?" target="_blank" rel="noopener noreferrer">vamos conversar!</a></p>        
      </div>
    </section>
  );
}
